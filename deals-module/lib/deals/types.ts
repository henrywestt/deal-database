...
export type ArenaView = "sport" | "culture";
export type TerritoryView = "anz" | "global";

export const CULTURE_ARENAS: Arena[] = [
  "music",
  "film_tv",
  "gaming",
  "health_wellness",
...
export const RIGHTS_LABEL: Record<RightsType, string> = {
...
export interface Deal {
  ...
  value_override_note: string | null;
  score: number;
